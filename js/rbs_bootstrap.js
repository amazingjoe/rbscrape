...
function bootstrap(callback) {
    ...
    document.querySelector('div[class*="styles__completionsList"]').style.display = 'none';
        ...
        createScript("https://cdn.jsdelivr.net/gh/amazingjoe/rbscrape@0.026/js/rbs_comtools.js", function() {
                    var newEl = document.createElement('div');
                    newEl.id = "rbscrape_nav";
                    var ref = document.querySelector('main');
                    insertBefore(newEl, ref);  

            createScript("https://cdn.jsdelivr.net/gh/amazingjoe/rbscrape@0.026/js/rbs_domtools.js", function() {
