...
function bootstrap(callback) {
    ...
    document.querySelector('div[class*="styles__completionsList"]').style.display = 'none';
        ...
        createScript("https://cdn.jsdelivr.net/gh/amazingjoe/rbscrape@0.018/js/rbs_comtools.js", function() {
            createScript("https://cdn.jsdelivr.net/gh/amazingjoe/rbscrape@0.018/js/rbs_domtools.js", function() {
