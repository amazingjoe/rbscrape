...
function bootstrap(callback) {
    ...
    createScript("https://cdn.jsdelivr.net/gh/amazingjoe/rbscrape@0.069/js/rbs_selectors.js", function() {

        createScript("https://cdn.jsdelivr.net/gh/amazingjoe/rbscrape@0.069/js/rbs_comtools.js", function() {
            createScript("https://cdn.jsdelivr.net/gh/amazingjoe/rbscrape@0.069/js/rbs_tabs.js", function() {
                createScript("https://cdn.jsdelivr.net/gh/amazingjoe/rbscrape@0.069/js/rbs_domtools.js", function() {
                    return callback();
                });
            });
        });
